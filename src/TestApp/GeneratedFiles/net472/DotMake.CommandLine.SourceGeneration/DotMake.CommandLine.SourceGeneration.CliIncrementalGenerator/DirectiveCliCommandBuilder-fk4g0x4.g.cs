    ...
    public class DirectiveCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        protected override System.CommandLine.Command DoBuild(DotMake.CommandLine.CliBindingContext bindingContext)
        {
            ...
            bindingContext.BinderMap[DefinitionType] = (instance, parseResult) =>
            {
                ...
                definitionInstance.Debug = GetValueForDirective<bool>(parseResult, directive0);
                definitionInstance.Directive2 = GetValueForDirective<string>(parseResult, directive1);
                definitionInstance.Vars = GetValueForDirective<string[]>(parseResult, directive2);
