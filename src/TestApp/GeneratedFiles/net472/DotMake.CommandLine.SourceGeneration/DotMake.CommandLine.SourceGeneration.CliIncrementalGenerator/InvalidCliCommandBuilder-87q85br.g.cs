...
namespace TestApp.Commands.GeneratedCode
{
    ...
    public class InvalidCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        protected override System.CommandLine.Command DoBuild(DotMake.CommandLine.CliBindingContext bindingContext)
        {
            ...
            {
                var targetClass = bindingContext.Bind<TestApp.Commands.InvalidCliCommand>(parseResult);
        ...
        public class SubCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
        {
            ...
            protected override System.CommandLine.Command DoBuild(DotMake.CommandLine.CliBindingContext bindingContext)
            {
                ...
                command.SetAction(parseResult =>
                {
                    var targetClass = bindingContext.Bind<TestApp.Commands.InvalidCliCommand.SubCliCommand>(parseResult);
