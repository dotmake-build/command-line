...
{
    /// <inheritdoc />
    public class NestedLevel2SubCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        /// <inheritdoc />
        public NestedLevel2SubCliCommandBuilder()
        {
            DefinitionType = typeof(TestApp.Commands.External.NestedExternalContainer.NestedLevel2SubCliCommand);
        ...
        protected override System.CommandLine.Command DoBuild(DotMake.CommandLine.CliBindingContext bindingContext)
        {
            ...
            var commandName = Namer.GetCommandName("NestedLevel2SubCliCommand");
            var command = IsRoot
            ...
            {
                return new TestApp.Commands.External.NestedExternalContainer.NestedLevel2SubCliCommand();
            };
            bindingContext.BinderMap[DefinitionType] = (instance, parseResult) =>
            {
                var definitionInstance = (TestApp.Commands.External.NestedExternalContainer.NestedLevel2SubCliCommand)instance;
            ...
            {
                var definitionInstance = bindingContext.Bind<TestApp.Commands.External.NestedExternalContainer.NestedLevel2SubCliCommand>(parseResult);
        ...
        {
            var commandBuilder = new TestApp.Commands.External.GeneratedCode.NestedLevel2SubCliCommandBuilder();
