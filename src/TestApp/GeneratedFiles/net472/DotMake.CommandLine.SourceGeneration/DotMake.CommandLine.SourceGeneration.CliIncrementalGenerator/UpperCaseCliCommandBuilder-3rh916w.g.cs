...
namespace TestApp.Commands.CasingConvention.GeneratedCode
{
    ...
    public class UpperCaseCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        protected override System.CommandLine.Command DoBuild(DotMake.CommandLine.CliBindingContext bindingContext)
        {
            ...
            var commandName = Namer.GetCommandName("UpperCaseCliCommand");
            var command = IsRoot
            ...
            {
                var definitionInstance = (TestApp.Commands.CasingConvention.UpperCaseCliCommand)instance;
            ...
            {
                var definitionInstance = bindingContext.Bind<TestApp.Commands.CasingConvention.UpperCaseCliCommand>(parseResult);
