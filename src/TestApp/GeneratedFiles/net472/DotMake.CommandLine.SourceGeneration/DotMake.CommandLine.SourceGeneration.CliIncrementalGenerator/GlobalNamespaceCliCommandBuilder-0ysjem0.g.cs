...
namespace GeneratedCode
{
    ...
    public class GlobalNamespaceCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        protected override System.CommandLine.Command DoBuild(DotMake.CommandLine.CliBindingContext bindingContext)
        {
            ...
            var commandName = Namer.GetCommandName("GlobalNamespaceCliCommand");
            var command = IsRoot
            ...
            {
                var definitionInstance = (GlobalNamespaceCliCommand)instance;
            ...
            {
                var definitionInstance = bindingContext.Bind<GlobalNamespaceCliCommand>(parseResult);
