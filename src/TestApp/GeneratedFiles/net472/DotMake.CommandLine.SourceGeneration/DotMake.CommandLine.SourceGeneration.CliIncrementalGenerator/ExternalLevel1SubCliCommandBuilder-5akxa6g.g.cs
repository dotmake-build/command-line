...
namespace TestApp.Commands.External.GeneratedCode
{
    ...
    public class ExternalLevel1SubCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        protected override System.CommandLine.Command DoBuild(DotMake.CommandLine.CliBindingContext bindingContext)
        {
            ...
            var commandName = Namer.GetCommandName("ExternalLevel1SubCliCommand");
            var command = IsRoot
            ...
            {
                var definitionInstance = (TestApp.Commands.External.ExternalLevel1SubCliCommand)instance;
            ...
            {
                var definitionInstance = bindingContext.Bind<TestApp.Commands.External.ExternalLevel1SubCliCommand>(parseResult);
