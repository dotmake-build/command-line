    ...
    public class DefaultValuesCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        protected override System.CommandLine.Command DoBuild(DotMake.CommandLine.CliBindingContext bindingContext)
        {
            ...
            bindingContext.BinderMap[DefinitionType] = (instance, parseResult) =>
            {
                ...
                definitionInstance.Opt1 = GetValueForOption(parseResult, option0);
                definitionInstance.Opt2 = GetValueForOption(parseResult, option1);
                definitionInstance.Opt3 = GetValueForOption(parseResult, option2);
                definitionInstance.Opt4 = GetValueForOption(parseResult, option3);
                definitionInstance.Opt5 = GetValueForOption(parseResult, option4);
                definitionInstance.Opt6 = GetValueForOption(parseResult, option5);
                definitionInstance.Opt8 = GetValueForOption(parseResult, option6);
                definitionInstance.Opt9 = GetValueForOption(parseResult, option7);
                definitionInstance.Opt10 = GetValueForOption(parseResult, option8);

                // Set the parsed or default values for the arguments
                definitionInstance.Arg1 = GetValueForArgument(parseResult, argument0);
                definitionInstance.Arg2 = GetValueForArgument(parseResult, argument1);
            };
