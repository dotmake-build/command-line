...
namespace TestApp.Commands.GeneratedCode
{
    ...
    public class LocalizedCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        protected override System.CommandLine.Command DoBuild(DotMake.CommandLine.CliBindingContext bindingContext)
        {
            ...
            var commandName = Namer.GetCommandName("LocalizedCliCommand");
            var command = IsRoot
            ...
            command.Description = TestApp.TestResources.CommandDescription;
            ...
            {
                var definitionInstance = (TestApp.Commands.LocalizedCliCommand)instance;
            ...
            {
                var definitionInstance = bindingContext.Bind<TestApp.Commands.LocalizedCliCommand>(parseResult);
