...
namespace TestApp.Commands.GeneratedCode
{
    ...
    public class ParentCommandAccessorCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        protected override System.CommandLine.Command DoBuild(DotMake.CommandLine.CliBindingContext bindingContext)
        {
            ...
            {
                var definitionInstance = (TestApp.Commands.ParentCommandAccessorCliCommand)instance;
                ...
                definitionInstance.GlobalOption1 = GetValueForOption(parseResult, option0);

                // Set the parsed or default values for the arguments
                definitionInstance.RootArgument1 = GetValueForArgument(parseResult, argument0);
            };

            command.SetAction(parseResult =>
            {
                var definitionInstance = bindingContext.Bind<TestApp.Commands.ParentCommandAccessorCliCommand>(parseResult);
        ...
        public class Level1SubCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
        {
            ...
            protected override System.CommandLine.Command DoBuild(DotMake.CommandLine.CliBindingContext bindingContext)
            {
                ...
                bindingContext.BinderMap[DefinitionType] = (instance, parseResult) =>
                {
                    var definitionInstance = (TestApp.Commands.ParentCommandAccessorCliCommand.Level1SubCliCommand)instance;

                    // Set the values for the command accessors
                    definitionInstance.RootCommand = bindingContext.Bind<TestApp.Commands.ParentCommandAccessorCliCommand>(parseResult);

                    // Set the parsed or default values for the directives

                    // Set the parsed or default values for the options
                    definitionInstance.Level1RecursiveOption1 = GetValueForOption(parseResult, option0);
                ...
                command.SetAction(parseResult =>
                {
                    var definitionInstance = bindingContext.Bind<TestApp.Commands.ParentCommandAccessorCliCommand.Level1SubCliCommand>(parseResult);
            ...
            public class Level2SubCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
            {
                ...
                protected override System.CommandLine.Command DoBuild(DotMake.CommandLine.CliBindingContext bindingContext)
                {
                    ...
                    bindingContext.BinderMap[DefinitionType] = (instance, parseResult) =>
                    {
                        var definitionInstance = (TestApp.Commands.ParentCommandAccessorCliCommand.Level1SubCliCommand.Level2SubCliCommand)instance;

                        // Set the values for the command accessors
                        definitionInstance.RootCommand = bindingContext.Bind<TestApp.Commands.ParentCommandAccessorCliCommand>(parseResult);
                        definitionInstance.ParentCommand = bindingContext.Bind<TestApp.Commands.ParentCommandAccessorCliCommand.Level1SubCliCommand>(parseResult);
                    ...
                    command.SetAction(parseResult =>
                    {
                        var definitionInstance = bindingContext.Bind<TestApp.Commands.ParentCommandAccessorCliCommand.Level1SubCliCommand.Level2SubCliCommand>(parseResult);
