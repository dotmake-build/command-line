    ...
    public class OptionBundlingCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        protected override System.CommandLine.Command DoBuild(DotMake.CommandLine.CliBindingContext bindingContext)
        {
            ...
            bindingContext.BinderMap[DefinitionType] = (instance, parseResult) =>
            {
                ...
                definitionInstance.A = GetValueForOption(parseResult, option0);
                definitionInstance.B = GetValueForOption(parseResult, option1);
                definitionInstance.C = GetValueForOption(parseResult, option2);
