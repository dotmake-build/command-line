...
namespace TestApp.Commands.CasingConvention.GeneratedCode
{
    ...
    public class CamelCaseCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        protected override System.CommandLine.Command DoBuild(DotMake.CommandLine.CliBindingContext bindingContext)
        {
            ...
            var commandName = Namer.GetCommandName("CamelCaseCliCommand");
            var command = IsRoot
            ...
            {
                var definitionInstance = (TestApp.Commands.CasingConvention.CamelCaseCliCommand)instance;
            ...
            {
                var definitionInstance = bindingContext.Bind<TestApp.Commands.CasingConvention.CamelCaseCliCommand>(parseResult);
