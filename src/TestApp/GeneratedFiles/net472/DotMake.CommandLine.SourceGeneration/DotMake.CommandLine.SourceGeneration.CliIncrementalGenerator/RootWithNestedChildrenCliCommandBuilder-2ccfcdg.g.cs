...
namespace TestApp.Commands.GeneratedCode
{
    ...
    public class RootWithNestedChildrenCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        private TestApp.Commands.RootWithNestedChildrenCliCommand CreateUninitializedInstance()
        {
            return (TestApp.Commands.RootWithNestedChildrenCliCommand)
        ...
        public class Level1SubCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
        {
            ...
            private TestApp.Commands.RootWithNestedChildrenCliCommand.Level1SubCliCommand CreateUninitializedInstance()
            {
                return (TestApp.Commands.RootWithNestedChildrenCliCommand.Level1SubCliCommand)
                #if NET5_0_OR_GREATER
                    System.Runtime.CompilerServices.RuntimeHelpers.GetUninitializedObject(DefinitionType);
                #else
                    System.Runtime.Serialization.FormatterServices.GetUninitializedObject(DefinitionType);
            ...
            public class Level2SubCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
            {
                ...
                private TestApp.Commands.RootWithNestedChildrenCliCommand.Level1SubCliCommand.Level2SubCliCommand CreateUninitializedInstance()
                {
                    return (TestApp.Commands.RootWithNestedChildrenCliCommand.Level1SubCliCommand.Level2SubCliCommand)
                    #if NET5_0_OR_GREATER
                        System.Runtime.CompilerServices.RuntimeHelpers.GetUninitializedObject(DefinitionType);
                    #else
                        System.Runtime.Serialization.FormatterServices.GetUninitializedObject(DefinitionType);
