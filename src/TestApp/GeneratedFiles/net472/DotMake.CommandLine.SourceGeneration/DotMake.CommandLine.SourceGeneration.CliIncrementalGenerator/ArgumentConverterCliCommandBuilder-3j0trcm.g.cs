    ...
    public class ArgumentConverterCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        protected override System.CommandLine.Command DoBuild(DotMake.CommandLine.CliBindingContext bindingContext)
        {
            ...
            bindingContext.BinderMap[DefinitionType] = (instance, parseResult) =>
            {
                ...
                definitionInstance.Opt = GetValueForOption(parseResult, option0);
                definitionInstance.OptArray = GetValueForOption(parseResult, option1);
                definitionInstance.OptNullable = GetValueForOption(parseResult, option2);
                definitionInstance.OptEnumerable = GetValueForOption(parseResult, option3);
                definitionInstance.OptList = GetValueForOption(parseResult, option4);
                definitionInstance.OptCustomList = GetValueForOption(parseResult, option5);

                // Set the parsed or default values for the arguments
                definitionInstance.Arg = GetValueForArgument(parseResult, argument0);
            };
