    ...
    public class NullableReferenceCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        public override System.CommandLine.CliCommand Build()
        {
            ...
            rootCommand.SetAction(parseResult =>
            {
                ...
                var targetClass = (TestApp.Commands.NullableReferenceCommand) BindFunc(cliBindContext);
        ...
        public class NullableBuilder : DotMake.CommandLine.CliCommandBuilder
        {
            ...
            public override System.CommandLine.CliCommand Build()
            {
                ...
                BindFunc = (cliBindContext) =>
                {
                    ...
                    targetClass.OptDefault = GetValueForOption(cliBindContext.ParseResult, option1);

                    //  Set the parsed or default values for the arguments
                    targetClass.Arg = GetValueForArgument(cliBindContext.ParseResult, argument0);
                    targetClass.ArgDefault = GetValueForArgument(cliBindContext.ParseResult, argument1);
                ...
                {
                    var cliBindContext = new DotMake.CommandLine.CliBindContext(parseResult);
                    var targetClass = (TestApp.Commands.NullableReferenceCommand.Nullable) BindFunc(cliBindContext);
        ...
        public class NonNullableBuilder : DotMake.CommandLine.CliCommandBuilder
        {
            ...
            public override System.CommandLine.CliCommand Build()
            {
                ...
                {
                    var cliBindContext = new DotMake.CommandLine.CliBindContext(parseResult);
                    var targetClass = (TestApp.Commands.NullableReferenceCommand.NonNullable) BindFunc(cliBindContext);
        ...
        public class RequiredBuilder : DotMake.CommandLine.CliCommandBuilder
        {
            ...
            public override System.CommandLine.CliCommand Build()
            {
                ...
                {
                    var cliBindContext = new DotMake.CommandLine.CliBindContext(parseResult);
                    var targetClass = (TestApp.Commands.NullableReferenceCommand.Required) BindFunc(cliBindContext);
