    ...
    public class EnumerableCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        public override System.CommandLine.CliCommand Build()
        {
            ...
            BindFunc = (cliBindContext) =>
            {
                ...
                targetClass.OptEnumerable = GetValueForOption(cliBindContext.ParseResult, option0);
                targetClass.OptList = GetValueForOption(cliBindContext.ParseResult, option1);
                targetClass.OptEnumArray = GetValueForOption(cliBindContext.ParseResult, option2);
                targetClass.OptCollection = GetValueForOption(cliBindContext.ParseResult, option3);
                targetClass.OptHashSet = GetValueForOption(cliBindContext.ParseResult, option4);
                targetClass.OptQueue = GetValueForOption(cliBindContext.ParseResult, option5);
                targetClass.OptCustomList = GetValueForOption(cliBindContext.ParseResult, option6);

                //  Set the parsed or default values for the arguments
                targetClass.ArgIList = GetValueForArgument(cliBindContext.ParseResult, argument0);
            ...
            rootCommand.SetAction(parseResult =>
            {
                ...
                var targetClass = (TestApp.Commands.EnumerableCliCommand) BindFunc(cliBindContext);
