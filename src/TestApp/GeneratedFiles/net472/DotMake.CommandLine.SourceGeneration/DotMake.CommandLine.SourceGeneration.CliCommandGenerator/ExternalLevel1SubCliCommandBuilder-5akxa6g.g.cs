...
namespace TestApp.Commands.External.GeneratedCode
{
    ...
    public class ExternalLevel1SubCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        public override System.CommandLine.CliCommand Build()
        {
            ...
            var command = new System.CommandLine.CliCommand("external-level-1")
            {
            ...
            command.SetAction(parseResult =>
            {
                ...
                var targetClass = (TestApp.Commands.External.ExternalLevel1SubCliCommand) BindFunc(cliBindContext);
        ...
        public class Level2SubCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
        {
            ...
            public override System.CommandLine.CliCommand Build()
            {
                ...
                {
                    var cliBindContext = new DotMake.CommandLine.CliBindContext(parseResult);
                    var targetClass = (TestApp.Commands.External.ExternalLevel1SubCliCommand.Level2SubCliCommand) BindFunc(cliBindContext);
