    ...
    public class RecursiveOptionCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        public override System.CommandLine.CliCommand Build()
        {
            ...
            BindFunc = (cliBindContext) =>
            {
                ...
                targetClass.RecursiveOption = GetValueForOption(cliBindContext.ParseResult, option0);
            ...
            rootCommand.SetAction(parseResult =>
            {
                ...
                var targetClass = (TestApp.Commands.RecursiveOptionCliCommand) BindFunc(cliBindContext);
        ...
        public class SubCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
        {
            ...
            public override System.CommandLine.CliCommand Build()
            {
                ...
                {
                    var cliBindContext = new DotMake.CommandLine.CliBindContext(parseResult);
                    var targetClass = (TestApp.Commands.RecursiveOptionCliCommand.SubCliCommand) BindFunc(cliBindContext);
