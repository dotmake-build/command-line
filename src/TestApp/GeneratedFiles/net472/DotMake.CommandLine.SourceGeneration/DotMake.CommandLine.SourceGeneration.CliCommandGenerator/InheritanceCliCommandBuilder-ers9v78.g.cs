...
namespace TestApp.Commands
{
    ...
    public class InheritanceCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        public override System.CommandLine.CliCommand Build()
        {
            ...
            option0.DefaultValueFactory = _ => defaultClass.Username;
            ...
            option2.CustomParser = GetParseArgument<string>
            (
                null
            );
            option2.DefaultValueFactory = _ => defaultClass.Department;
            ...
            {
                var targetClass = (TestApp.Commands.InheritanceCliCommand) BindFunc(parseResult);
