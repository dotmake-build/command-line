...
namespace TestApp.Commands.GeneratedCode
{
    ...
    public class RootHelpOnEmptyCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        protected override System.CommandLine.Command DoBuild(DotMake.CommandLine.CliBindingContext bindingContext)
        {
            ...
            var commandName = Namer.GetCommandName("RootHelpOnEmptyCliCommand");
            var command = IsRoot
            ...
            {
                var definitionInstance = (TestApp.Commands.RootHelpOnEmptyCliCommand)instance;
            ...
            {
                var definitionInstance = bindingContext.Bind<TestApp.Commands.RootHelpOnEmptyCliCommand>(parseResult);
