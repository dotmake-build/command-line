...
namespace TestApp.Commands.GeneratedCode
{
    ...
    public class RecursiveOptionCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        private TestApp.Commands.RecursiveOptionCliCommand CreateUninitializedInstance()
        {
            return (TestApp.Commands.RecursiveOptionCliCommand)
        ...
        public class SubCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
        {
            ...
            private TestApp.Commands.RecursiveOptionCliCommand.SubCliCommand CreateUninitializedInstance()
            {
                return (TestApp.Commands.RecursiveOptionCliCommand.SubCliCommand)
                #if NET5_0_OR_GREATER
                    System.Runtime.CompilerServices.RuntimeHelpers.GetUninitializedObject(DefinitionType);
                #else
                    System.Runtime.Serialization.FormatterServices.GetUninitializedObject(DefinitionType);
