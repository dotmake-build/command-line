    ...
    public class EnumerableCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        protected override System.CommandLine.Command DoBuild(DotMake.CommandLine.CliBindingContext bindingContext)
        {
            ...
            bindingContext.BinderMap[DefinitionType] = (instance, parseResult) =>
            {
                ...
                definitionInstance.OptEnumerable = GetValueForOption(parseResult, option0);
                definitionInstance.OptList = GetValueForOption(parseResult, option1);
                definitionInstance.OptEnumArray = GetValueForOption(parseResult, option2);
                definitionInstance.OptCollection = GetValueForOption(parseResult, option3);
                definitionInstance.OptHashSet = GetValueForOption(parseResult, option4);
                definitionInstance.OptQueue = GetValueForOption(parseResult, option5);
                definitionInstance.OptCustomList = GetValueForOption(parseResult, option6);

                // Set the parsed or default values for the arguments
                definitionInstance.ArgIList = GetValueForArgument(parseResult, argument0);
            };
