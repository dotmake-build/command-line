...
namespace TestApp.Commands.External.GeneratedCode
{
    ...
    public class ExternalLevel2WithParentSubCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        protected override System.CommandLine.Command DoBuild(DotMake.CommandLine.CliBindingContext bindingContext)
        {
            ...
            var commandName = Namer.GetCommandName("ExternalLevel2WithParentSubCliCommand");
            var command = IsRoot
            ...
            {
                var definitionInstance = (TestApp.Commands.External.ExternalLevel2WithParentSubCliCommand)instance;
            ...
            {
                var definitionInstance = bindingContext.Bind<TestApp.Commands.External.ExternalLevel2WithParentSubCliCommand>(parseResult);
