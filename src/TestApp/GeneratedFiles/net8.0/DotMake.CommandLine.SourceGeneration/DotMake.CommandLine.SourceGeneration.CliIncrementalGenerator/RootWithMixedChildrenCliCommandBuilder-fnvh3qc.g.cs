...
namespace TestApp.Commands.GeneratedCode
{
    ...
    public class RootWithMixedChildrenCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        protected override System.CommandLine.Command DoBuild(DotMake.CommandLine.CliBindingContext bindingContext)
        {
            ...
            var commandName = Namer.GetCommandName("RootWithMixedChildrenCliCommand");
            var command = IsRoot
            ...
            {
                var definitionInstance = (TestApp.Commands.RootWithMixedChildrenCliCommand)instance;
            ...
            {
                var definitionInstance = bindingContext.Bind<TestApp.Commands.RootWithMixedChildrenCliCommand>(parseResult);
        ...
        public class Level1SubCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
        {
            ...
            protected override System.CommandLine.Command DoBuild(DotMake.CommandLine.CliBindingContext bindingContext)
            {
                ...
                bindingContext.BinderMap[DefinitionType] = (instance, parseResult) =>
                {
                    var definitionInstance = (TestApp.Commands.RootWithMixedChildrenCliCommand.Level1SubCliCommand)instance;
                ...
                command.SetAction(parseResult =>
                {
                    var definitionInstance = bindingContext.Bind<TestApp.Commands.RootWithMixedChildrenCliCommand.Level1SubCliCommand>(parseResult);
