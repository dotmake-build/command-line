...
namespace TestApp.Commands.CasingConvention.GeneratedCode
{
    ...
    public class SnakeCaseCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        protected override System.CommandLine.Command DoBuild(DotMake.CommandLine.CliBindingContext bindingContext)
        {
            ...
            var commandName = Namer.GetCommandName("SnakeCaseCliCommand");
            var command = IsRoot
            ...
            {
                var definitionInstance = (TestApp.Commands.CasingConvention.SnakeCaseCliCommand)instance;
            ...
            {
                var definitionInstance = bindingContext.Bind<TestApp.Commands.CasingConvention.SnakeCaseCliCommand>(parseResult);
