...
namespace TestApp.Commands.External.GeneratedCode
{
    ...
    public class ExternalLevel1WithNestedSubCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        protected override System.CommandLine.Command DoBuild(DotMake.CommandLine.CliBindingContext bindingContext)
        {
            ...
            {
                var targetClass = bindingContext.Bind<TestApp.Commands.External.ExternalLevel1WithNestedSubCliCommand>(parseResult);
        ...
        public class Level2SubCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
        {
            ...
            protected override System.CommandLine.Command DoBuild(DotMake.CommandLine.CliBindingContext bindingContext)
            {
                ...
                command.SetAction(parseResult =>
                {
                    var targetClass = bindingContext.Bind<TestApp.Commands.External.ExternalLevel1WithNestedSubCliCommand.Level2SubCliCommand>(parseResult);
