...
namespace TestApp.Commands.CasingConvention.GeneratedCode
{
    ...
    public class NoCaseCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        protected override System.CommandLine.Command DoBuild(DotMake.CommandLine.CliBindingContext bindingContext)
        {
            ...
            var commandName = Namer.GetCommandName("NoCaseCliCommand");
            var command = IsRoot
            ...
            {
                var definitionInstance = (TestApp.Commands.CasingConvention.NoCaseCliCommand)instance;
            ...
            {
                var definitionInstance = bindingContext.Bind<TestApp.Commands.CasingConvention.NoCaseCliCommand>(parseResult);
