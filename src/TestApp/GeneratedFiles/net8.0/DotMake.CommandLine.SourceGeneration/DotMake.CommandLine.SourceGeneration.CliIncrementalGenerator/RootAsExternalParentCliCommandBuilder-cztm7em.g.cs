...
namespace TestApp.Commands.GeneratedCode
{
    ...
    public class RootAsExternalParentCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        protected override System.CommandLine.Command DoBuild(DotMake.CommandLine.CliBindingContext bindingContext)
        {
            ...
            var commandName = Namer.GetCommandName("RootAsExternalParentCliCommand");
            var command = IsRoot
            ...
            {
                var definitionInstance = (TestApp.Commands.RootAsExternalParentCliCommand)instance;
            ...
            {
                var definitionInstance = bindingContext.Bind<TestApp.Commands.RootAsExternalParentCliCommand>(parseResult);
