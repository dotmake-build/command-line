    ...
    public class ShortFormCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        protected override System.CommandLine.Command DoBuild(DotMake.CommandLine.CliBindingContext bindingContext)
        {
            ...
            bindingContext.BinderMap[DefinitionType] = (instance, parseResult) =>
            {
                ...
                definitionInstance.Oauth2GrantType = GetValueForOption(parseResult, option0);
                definitionInstance.Oauth2TokenUrl = GetValueForOption(parseResult, option1);
                definitionInstance.Oauth2ClientId = GetValueForOption(parseResult, option2);
                definitionInstance.Oauth2ClientSecret = GetValueForOption(parseResult, option3);
                definitionInstance.Sha256 = GetValueForOption(parseResult, option4);
                definitionInstance.Option1 = GetValueForOption(parseResult, option5);
                definitionInstance.Option1Option = GetValueForOption(parseResult, option6);
                definitionInstance.Option2 = GetValueForOption(parseResult, option7);
                definitionInstance.Option3 = GetValueForOption(parseResult, option8);

                // Set the parsed or default values for the arguments
                definitionInstance.Argument1 = GetValueForArgument(parseResult, argument0);
                definitionInstance.Argument1Argument = GetValueForArgument(parseResult, argument1);
                definitionInstance.Option1Argument = GetValueForArgument(parseResult, argument2);
            };
