    ...
    public class WriteFileCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        public override System.CommandLine.CliCommand Build()
        {
            ...
            BindFunc = (cliBindContext) =>
            {
                ...
                targetClass.Lines = GetValueForOption(cliBindContext.ParseResult, option0);

                //  Set the parsed or default values for the arguments
                targetClass.OutputFile = GetValueForArgument(cliBindContext.ParseResult, argument0);
            ...
            rootCommand.SetAction(parseResult =>
            {
                ...
                var targetClass = (TestApp.Commands.WriteFileCommand) BindFunc(cliBindContext);
