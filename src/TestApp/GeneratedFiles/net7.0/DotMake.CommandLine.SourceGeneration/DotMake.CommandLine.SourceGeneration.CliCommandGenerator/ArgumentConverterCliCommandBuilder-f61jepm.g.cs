...
namespace TestApp.Commands
{
    ...
    public class ArgumentConverterCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        public override System.CommandLine.CliCommand Build()
        {
            ...
            option0.CustomParser = GetParseArgument<TestApp.Commands.ClassWithConstructor>
            (
                input => new TestApp.Commands.ClassWithConstructor(input)
            );
            option0.DefaultValueFactory = _ => defaultClass.Opt;
            ...
            option1.CustomParser = GetParseArgument<TestApp.Commands.ClassWithConstructor[], TestApp.Commands.ClassWithConstructor>
            (
                array => (TestApp.Commands.ClassWithConstructor[])array,
                item => new TestApp.Commands.ClassWithConstructor(item)
            );
            option1.DefaultValueFactory = _ => defaultClass.OptArray;
            ...
            option2.CustomParser = GetParseArgument<TestApp.Commands.CustomStruct?>
            (
                input => new TestApp.Commands.CustomStruct(input)
            );
            option2.DefaultValueFactory = _ => defaultClass.OptNullable;
            ...
            option3.CustomParser = GetParseArgument<System.Collections.Generic.IEnumerable<TestApp.Commands.ClassWithConstructor>, TestApp.Commands.ClassWithConstructor>
            (
                array => (TestApp.Commands.ClassWithConstructor[])array,
                item => new TestApp.Commands.ClassWithConstructor(item)
            );
            option3.DefaultValueFactory = _ => defaultClass.OptEnumerable;
            ...
            option4.CustomParser = GetParseArgument<System.Collections.Generic.List<TestApp.Commands.ClassWithConstructor>, TestApp.Commands.ClassWithConstructor>
            (
            ...
            option4.DefaultValueFactory = _ => defaultClass.OptList;
            ...
            option5.CustomParser = GetParseArgument<TestApp.Commands.CustomList<TestApp.Commands.ClassWithConstructor>, TestApp.Commands.ClassWithConstructor>
            (
                array => new TestApp.Commands.CustomList<TestApp.Commands.ClassWithConstructor>((TestApp.Commands.ClassWithConstructor[])array),
                item => new TestApp.Commands.ClassWithConstructor(item)
            );
            option5.DefaultValueFactory = _ => defaultClass.OptCustomList;
            ...
            argument0.CustomParser = GetParseArgument<System.Collections.Generic.IEnumerable<TestApp.Commands.ClassWithParser>, TestApp.Commands.ClassWithParser>
            (
