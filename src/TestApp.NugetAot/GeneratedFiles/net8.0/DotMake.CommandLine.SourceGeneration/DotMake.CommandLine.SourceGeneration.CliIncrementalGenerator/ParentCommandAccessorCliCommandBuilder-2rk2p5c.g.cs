...
namespace TestApp.Commands.GeneratedCode
{
    ...
    public class ParentCommandAccessorCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        private TestApp.Commands.ParentCommandAccessorCliCommand CreateUninitializedInstance()
        {
            return (TestApp.Commands.ParentCommandAccessorCliCommand)
        ...
        public override System.CommandLine.Command Build()
        {
            ...
            var command = IsRoot
                ...
                : new System.CommandLine.Command(GetCommandName("ParentCommandAccessor"));
        ...
        public class Level1SubCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
        {
            ...
            private TestApp.Commands.ParentCommandAccessorCliCommand.Level1SubCliCommand CreateUninitializedInstance()
            {
                return (TestApp.Commands.ParentCommandAccessorCliCommand.Level1SubCliCommand)
                #if NET5_0_OR_GREATER
                    System.Runtime.CompilerServices.RuntimeHelpers.GetUninitializedObject(DefinitionType);
                #else
                    System.Runtime.Serialization.FormatterServices.GetUninitializedObject(DefinitionType);
            ...
            public override System.CommandLine.Command Build()
            {
                ...
                var option0 = new System.CommandLine.Option<string>
                (
                    GetOptionName("Level1RecursiveOption1")
                )
                {
                    Recursive = true,
            ...
            public class Level2SubCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
            {
                ...
                private TestApp.Commands.ParentCommandAccessorCliCommand.Level1SubCliCommand.Level2SubCliCommand CreateUninitializedInstance()
                {
                    return (TestApp.Commands.ParentCommandAccessorCliCommand.Level1SubCliCommand.Level2SubCliCommand)
                    #if NET5_0_OR_GREATER
                        System.Runtime.CompilerServices.RuntimeHelpers.GetUninitializedObject(DefinitionType);
                    #else
                        System.Runtime.Serialization.FormatterServices.GetUninitializedObject(DefinitionType);
