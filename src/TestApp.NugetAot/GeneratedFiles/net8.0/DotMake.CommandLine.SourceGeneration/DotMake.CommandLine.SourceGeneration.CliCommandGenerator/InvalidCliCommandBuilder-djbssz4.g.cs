...
namespace TestApp.Commands
{
    ...
    public class InvalidCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        public override System.CommandLine.CliCommand Build()
        {
            ...
            {
                var targetClass = (TestApp.Commands.InvalidCliCommand) BindFunc(parseResult);
        ...
        {
            var commandBuilder = new TestApp.Commands.InvalidCliCommandBuilder();
        ...
        public class SubCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
        {
            ...
            public override System.CommandLine.CliCommand Build()
            {
                ...
                {
                    var targetClass = (TestApp.Commands.InvalidCliCommand.SubCliCommand) BindFunc(parseResult);
            ...
            internal static void Initialize()
            {
                var commandBuilder = new TestApp.Commands.InvalidCliCommandBuilder.SubCliCommandBuilder();
