...
namespace TestApp.NugetDI.Commands
{
    ...
    public class RootCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        public override System.CommandLine.Command Build()
        {
            ...
            {
                var targetClass = (TestApp.NugetDI.Commands.RootCliCommand) BindFunc(context.ParseResult);
        ...
        {
            var commandBuilder = new TestApp.NugetDI.Commands.RootCliCommandBuilder();
