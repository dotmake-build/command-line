...
namespace DotMake.CommandLine
{
	...
	public abstract class CliCommandBuilder
	{
		...
		private static readonly Dictionary<Type, CliCommandBuilder> RegisteredDefinitionTypes = new Dictionary<Type, CliCommandBuilder>();
		private static readonly Dictionary<Type, HashSet<CliCommandBuilder>> RegisteredParentDefinitionTypes = new Dictionary<Type, HashSet<CliCommandBuilder>>();
