...
namespace DotMake.CommandLine
{
	...
	public class DotMakeCliCommandAttribute : Attribute
	{
		/// <summary>
		...
		/// <para>Default is <see cref="DotMakeCliCasingConvention.KebabCase"/> (e.g. <c>kebab-case</c>).</para>
		/// </summary>
		public DotMakeCliCasingConvention NameCasingConvention { get; set; } = DotMakeCliCasingConvention.KebabCase;
		...
		/// <para>Default is <see cref="DotMakeCliPrefixConvention.DoubleHyphen"/> (e.g. <c>--option</c>).</para>
		/// </summary>
		public DotMakeCliPrefixConvention NamePrefixConvention { get; set; } = DotMakeCliPrefixConvention.DoubleHyphen;
		...
		/// This setting will be inherited by child options and subcommands.
		/// <para>Default is <see cref="DotMakeCliPrefixConvention.SingleHyphen"/> (e.g. <c>-o</c>).</para>
		/// </summary>
		public DotMakeCliPrefixConvention ShortFormPrefixConvention { get; set; } = DotMakeCliPrefixConvention.SingleHyphen;
		...
		/// <summary>
		/// Gets the default instance of <see cref="DotMakeCliCommandAttribute" />.
		/// </summary>
		/// <value>The default instance of <see cref="DotMakeCliCommandAttribute" />.</value>
		public static DotMakeCliCommandAttribute Default { get; } = new DotMakeCliCommandAttribute();
	}
}