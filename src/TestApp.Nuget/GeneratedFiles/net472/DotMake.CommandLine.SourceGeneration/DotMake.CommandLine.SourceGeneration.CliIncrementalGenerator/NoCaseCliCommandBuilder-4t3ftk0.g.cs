...
namespace TestApp.Commands.CasingConvention.GeneratedCode
{
    ...
    public class NoCaseCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        private TestApp.Commands.CasingConvention.NoCaseCliCommand CreateUninitializedInstance()
        {
            return (TestApp.Commands.CasingConvention.NoCaseCliCommand)
        ...
        public override System.CommandLine.Command Build()
        {
            ...
            var command = IsRoot
                ...
                : new System.CommandLine.Command(GetCommandName("NoCase"));
            ...
            {
                var targetClass = (TestApp.Commands.CasingConvention.NoCaseCliCommand) Bind(parseResult);
        ...
        {
            var commandBuilder = new TestApp.Commands.CasingConvention.GeneratedCode.NoCaseCliCommandBuilder();
