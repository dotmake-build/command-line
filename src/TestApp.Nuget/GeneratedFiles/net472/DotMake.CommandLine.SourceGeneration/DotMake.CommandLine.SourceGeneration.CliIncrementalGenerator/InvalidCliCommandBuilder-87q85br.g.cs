...
namespace TestApp.Commands.GeneratedCode
{
    ...
    public class InvalidCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        private TestApp.Commands.InvalidCliCommand CreateUninitializedInstance()
        {
            return (TestApp.Commands.InvalidCliCommand)
        ...
        public override System.CommandLine.Command Build()
        {
            ...
            var command = IsRoot
                ...
                : new System.CommandLine.Command(GetCommandName("Invalid"));
        ...
        public class SubCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
        {
            ...
            private TestApp.Commands.InvalidCliCommand.SubCliCommand CreateUninitializedInstance()
            {
                return (TestApp.Commands.InvalidCliCommand.SubCliCommand)
                #if NET5_0_OR_GREATER
                    System.Runtime.CompilerServices.RuntimeHelpers.GetUninitializedObject(DefinitionType);
                #else
                    System.Runtime.Serialization.FormatterServices.GetUninitializedObject(DefinitionType);
