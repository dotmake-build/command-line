...
{
	public class SingleHyphenCliCommandBuilder : DotMake.CommandLine.DotMakeCommandBuilder
	{
		public SingleHyphenCliCommandBuilder()
		{
			...
			NamePrefixConvention = DotMake.CommandLine.DotMakeCliPrefixConvention.SingleHyphen;
