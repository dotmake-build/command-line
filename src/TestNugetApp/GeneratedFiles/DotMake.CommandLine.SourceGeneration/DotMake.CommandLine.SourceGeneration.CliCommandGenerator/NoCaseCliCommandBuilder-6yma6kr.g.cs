...
{
	public class NoCaseCliCommandBuilder : DotMake.CommandLine.DotMakeCommandBuilder
	{
		public NoCaseCliCommandBuilder()
		{
			DefinitionType = typeof(TestApp.Commands.CasingConvention.NoCaseCliCommand);
			ParentDefinitionType = null;
			NameCasingConvention = DotMake.CommandLine.DotMakeCliCasingConvention.None;
