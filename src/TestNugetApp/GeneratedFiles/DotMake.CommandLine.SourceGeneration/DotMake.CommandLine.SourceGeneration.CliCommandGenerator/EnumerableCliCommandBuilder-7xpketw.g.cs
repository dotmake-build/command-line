...
namespace TestApp.Commands
{
    public class EnumerableCliCommandBuilder : DotMake.CommandLine.CliCommandBuilder
    {
        ...
        public override System.CommandLine.RootCommand Build()
        {
            ...
            var option3 = new System.CommandLine.Option<System.Collections.ObjectModel.Collection<string>>
            (
                "--opt-collection",
                GetParseArgument<System.Collections.ObjectModel.Collection<string>, string>
                (
                    array => new System.Collections.ObjectModel.Collection<string>(System.Linq.Enumerable.ToList((string[])array)),
                    null
                )
            )
            {
